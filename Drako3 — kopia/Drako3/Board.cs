   ...
   public class Board
    {
       ...
       // private  string libraryImage = new Image();
       // [DataMember(IsRequired = false)]
      //  private string dragonLibrary = new Image();
        //[DataMember(IsRequired = false)]
      //  private string dwarfLibrary = new Image();
        private string dragonLibrary = "Images/Dragon.jpg";
        private string dwarfLibrary = "Images/Dwarf.jpg";
...
//BitmapImage src = new BitmapImage();
      ...
      //      dragonLibrary.Source = src2;
            ...
            corners = new List<Point>();
               // hexs.Add(new Hex(new Point(((center.X - hexWidth) + j * hexWidth), (center.Y - 1.5 * hexHeight)), new Point(0, -2)));
