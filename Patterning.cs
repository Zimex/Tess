    ...
    class Patterning
    {
        ...
        public void FillPatterns()
        {
          ...
          //  this.patterns.Add("ulica", "((ul.)|(ul)|(ul )|(ul. )|(uł )|(uł. )|(uł)|(uł.)|(u1 )|(u1. )|(u1)|(u1.)|(uI )|(uI. )|(uI)|(uI.))([a-z]{3,})");
           ...
           // this.patterns.Add("telefon1", @"\s((\()?([0-9]{1}-?[0-9]{2})(\))?)?(\s)?([0-9]{3}(-|(\s))?[0-9]{2}(-|(\s))?[0-9]{2})((\s)|,)");
            this.patterns.Add("telefon2", @"\s((\()?([0-9]{1}-?[0-9]{2})(\))?)?(\s)?([0-9]{3}(-|(\s))?[0-9]{2}(-|(\s))?[0-9]{2})\D");
            this.patterns.Add("telefon1", @"\s((\()?([0-9]{1}-?[0-9]{2})(\))?)?(\s)?([0-9]{3}(-|(\s))?[0-9]{2}(-|(\s))?[0-9]{2})\D");
        ...
        public void InitiateResults()
        {
           //faktury
            ...
            this.results.Add("netto faktura", String.Empty);
